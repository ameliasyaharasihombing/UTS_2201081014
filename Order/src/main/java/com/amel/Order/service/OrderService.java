 ...
 */
package com.amel.Order.service;

import com.amel.Order.entity.Order;
import com.amel.Order.repository.OrderRepository;
import com.amel.Order.vo.Product;
import com.amel.Order.vo.ResponseTemplate;
...
@Autowired
    ...
    public void update(Long orderId,Integer jumlah,String tanggal, String status){
     ...
     public ResponseTemplate getOrderWithProductById(Long id){
         ...
         Product product = restTemplate.getForObject("http://localhost:9005/api/v1/product/" +order.getProductId(), Product.class);
