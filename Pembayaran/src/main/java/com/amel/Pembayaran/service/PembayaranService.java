 ...
 */
package com.amel.Pembayaran.service;

import com.amel.Pembayaran.entity.Pembayaran;
import com.amel.Pembayaran.repository.PembayaranRepository;
import com.amel.Pembayaran.vo.Order;
import com.amel.Pembayaran.vo.ResponseTemplate;
...
@Autowired
    ...
    public void update(Long pembayaranId,String mode_pembayaran, String nomor_referensi, String tgl_bayar ){
     ...
     public ResponseTemplate getPembayaranWithOrderById(Long id){
         ...
         Order order = restTemplate.getForObject("http://localhost:9004/api/v1/order/" +pembayaran.getOrder_Id(), Order.class);
